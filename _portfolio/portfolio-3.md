...
**Highlights:** <br/>
- **PLC Programming:** Development of ladder logic for conveyor control using Siemens S7 PLCs. <br/>
- **HMI Development:** Design of operator interfaces using **LS Electric XP Builder (Korea)** for monitoring and control. <br/>
